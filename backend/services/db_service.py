...
def _fund_to_dict(f: DailyFundData) -> dict:
    ...
    return {
        ...
        "tracking_error_1y": fmt(f.tracking_error_1y),
        "tracking_error_3y": fmt(f.tracking_error_3y),
        "tracking_error_5y": fmt(f.tracking_error_5y),
        ...
        "credit_bb": fmt(f.credit_bb),
        "credit_b": fmt(f.credit_b),
        "credit_below_b": fmt(f.credit_below_b),
        "credit_nr": fmt(f.credit_nr),
        "fi_sector_government": fmt(f.fi_sector_government),
        "fi_sector_corporate": fmt(f.fi_sector_corporate),
        "fi_sector_cash_equiv": fmt(f.fi_sector_cash_equiv),
        "fi_sector_municipal": fmt(f.fi_sector_municipal),
        "fi_sector_securitized": fmt(f.fi_sector_securitized),
        "fi_sector_derivative": fmt(f.fi_sector_derivative),
        "has_debt_columns": bool(f.has_debt_columns),
        "has_equity_columns": bool(f.has_equity_columns),
